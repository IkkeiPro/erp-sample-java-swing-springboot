        ...
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        List.of(
                                row("A", "A", 0),
                                row("", "B", 1)),
                        "2行目: 親ファイル・子ファイルは必須です。"),
                Arguments.of(
                        "レベル0で親子不一致",
                        List.of(
                                row("A", "X", 0),
                                row("A", "B", 1)),
                        "1行目: レベル0は親ファイルと子ファイルが同一である必要があります。"),
                Arguments.of(
                        "レベル0の親ファイルが複数",
                        List.of(
                                row("A", "A", 0),
                                row("B", "B", 0)),
                        "レベル0の親ファイルは1つに統一してください。"),
                Arguments.of(
                        "レベル1以降で親子同一",
                        List.of(
                                row("A", "A", 0),
                                row("A", "A", 1)),
                        "2行目: レベル1以降は親ファイルと子ファイルを同一にできません。"),
                Arguments.of(
                        "ルート件数が1件でない",
                        List.of(
                                row("A", "B", 1)),
